...
\end{aligned}
	 \]
	 \[
	 \Big\|\nabla_{Y_s^h}b_s(\cdot,\delta_{X_{s}^{0}})(X_s^0+r(Y_s^{\varepsilon,h_\varepsilon}-X_s^0)) -\nabla_{Y_s^h}b_s(\cdot,\delta_{X_s^0})(X_s^0)\Big\|\leq K(s)\Big(\Big|X_s^0+r(Y_s^{\varepsilon,h_\varepsilon}-X_s^0)\Big|\Big)|Y^h_s|
	 \]
	 Ainsi,
	 \[
	 \begin{aligned}
	 	|I_1^{\varepsilon,h_\varepsilon}(t)| &\leq\int_{0}^{t}\int_{0}^{1}K(s)|\overline{Y}_s^{\varepsilon,h_\varepsilon}-Y_s^h|drds\\&+\int_{0}^{t}\int_{0}^{1}K(s)\Big(\Big|X_s^0+r(Y_s^{\varepsilon,h_\varepsilon}-X_s^0)\Big|\Big)|Y^h_s|drds\\
	 	&\leq \int_{0}^{t}\int_{0}^{1}K(s)|\overline{Y}_s^{\varepsilon,h_\varepsilon}-Y_s^h|drds\\&+\int_{0}^{t}\int_{0}^{1}K(s)\Big(\Big|X_s^0+r(X_s^0+\sqrt{\varepsilon}\lambda(\varepsilon)\overline{Y}_s^{\varepsilon,h_\varepsilon}-X_s^0)\Big|\Big)|Y^h_s|drds\\
	 	&\leq  \int_{0}^{t}\int_{0}^{1}K(s)|\overline{Y}_s^{\varepsilon,h_\varepsilon}-Y_s^h|drds\\&+\int_{0}^{t}\int_{0}^{1}K(s)\Big(\Big|X_s^0+r\sqrt{\varepsilon}\lambda(\varepsilon)\overline{Y}_s^{\varepsilon,h_\varepsilon}\Big|\Big)|Y^h_s|drds\\
	 \end{aligned}
	 \]
